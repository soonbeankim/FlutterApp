...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  Future<String> _calculation = Future.delayed(Duration(seconds: 4), () => 'Large Latte');
      ...
      child: FutureBuilder<String>(//////////////////////
        ...
        builder: (BuildContext context, AsyncSnapshot<String> snapshot) {
          ...
          if (snapshot.hasData) {
            children = <Widget>[
               Image(
            image: NetworkImage('https://globalassets.starbucks.com/assets/b635f407bbcd49e7b8dd9119ce33f76e.jpg?impolicy=1by1_wide_1242'),
            width: 300,
            height: 150,
